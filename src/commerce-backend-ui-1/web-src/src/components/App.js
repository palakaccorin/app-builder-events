...
import { CustomerMassActionWithRedirect } from './CustomerMassActionWithRedirect'
import { CustomerMassAction } from './CustomerMassAction'
          ...
          <HashRouter>
              <Provider theme={lightTheme} colorScheme={'light'}>
                  <Routes>
                      ...
                      <Route path={'customer-mass-action'} element={<CustomerMassAction runtime={props.runtime} ims={props.ims} />} />
                      <Route path={'mass-action-with-redirect'} element={<CustomerMassActionWithRedirect runtime={props.runtime} ims={props.ims} />} />
